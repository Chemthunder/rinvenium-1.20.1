...
public class RinveniumFoodComponents {
    ...
    public static final FoodComponent ION_CELL = new FoodComponent.Builder().hunger(8).saturationModifier(1.2f).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 8, 0), 1.0f).alwaysEdible().build();
